 ...
 * @method static \Illuminate\Database\Eloquent\Builder|Balance whereWalletId($value)
 */
 ...
 * @property int $id
 * @property string $name
 * @property string $pfx_symbol
 * @property string $sfx_symbol
 * @property string $unit_name
 * @property string $cent_name
 * @property string $symbol_name
 * @property int $scale
 * @property-read \Illuminate\Database\Eloquent\Collection<int, \App\Models\Balance> $balances
 * @property-read int|null $balances_count
 * @method static \Illuminate\Database\Eloquent\Builder|Currency newModelQuery()
 * @method static \Illuminate\Database\Eloquent\Builder|Currency newQuery()
 * @method static \Illuminate\Database\Eloquent\Builder|Currency query()
 * @method static \Illuminate\Database\Eloquent\Builder|Currency whereCentName($value)
 * @method static \Illuminate\Database\Eloquent\Builder|Currency whereId($value)
 * @method static \Illuminate\Database\Eloquent\Builder|Currency whereName($value)
 * @method static \Illuminate\Database\Eloquent\Builder|Currency wherePfxSymbol($value)
 * @method static \Illuminate\Database\Eloquent\Builder|Currency whereScale($value)
 * @method static \Illuminate\Database\Eloquent\Builder|Currency whereSfxSymbol($value)
 * @method static \Illuminate\Database\Eloquent\Builder|Currency whereSymbolName($value)
 * @method static \Illuminate\Database\Eloquent\Builder|Currency whereUnitName($value)
 */
 ...
 * @method static \Illuminate\Database\Eloquent\Builder|Wallet whereColor($value)
 * @method static \Illuminate\Database\Eloquent\Builder|Wallet whereCreatedAt($value)
 * @method static \Illuminate\Database\Eloquent\Builder|Wallet whereId($value)
 * @method static \Illuminate\Database\Eloquent\Builder|Wallet whereIncludeToStats($value)
 * @method static \Illuminate\Database\Eloquent\Builder|Wallet whereInitialBalance($value)
